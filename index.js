...
const {order, payment, notificationsMidtransServer, createInvoice, resendInvoice, getAllInvoice, getAllUserOrder, getUserOrderByIdOrder, refund} = require("./controller/OrderController")
const prefix = '/v1/api/';
...
app.post(prefix + 'refund/:orderId', verifyToken, refund);
...
app.get(prefix + 'order-all', verifyToken, getAllUserOrder );
app.get(prefix + 'order-all/:orderId', verifyToken, getUserOrderByIdOrder );

// INVOICE ADMIN
app.get(prefix + 'admin/invoice', verifyAdmin, getAllInvoice );
